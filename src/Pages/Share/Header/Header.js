...
const Header = () => {
    ...
    const menuItems = <>
        <>
            ...
            <li className='font-semibold'><Link to={'/'}>FAQ</Link></li>
        </>
    </>
                ...
                <div className="navbar-start lg:ml-3">
                    ...
                    <div className=' flex items-center'>
                        ...
                        <Link to={'/'} className="btn btn-ghost normal-case text-xl font-bold ">
                            <span className='text-orange-600'>Licht</span> &nbsp;<span>Photo</span><span className='text-yellow-500'>grapher</span>
                        </Link>
                    </div>
                </div>
                    ...
                    <div className=' flex items-center'>
                        ...
                        <div className=" dropdown  text-gray-900">
                            <label tabIndex={0} className="lg:hidden">
                                <Link to={'/'} className="btn btn-ghost normal-case text-xl font-bold ">
                                    <span className='text-orange-600'>Licht</span> &nbsp;<span className='text-yellow-500'>grapher</span>
                                </Link>
